...
class CogitoBot_Admin_Error_WC_Version {
  ...
  public static function output() {
		wp_register_style( 'admin-error-wc-version-style', COGITO_BOT__PLUGIN_URL .'assets/css/admin-error-wc-version-style.css');
		wp_enqueue_style( 'admin-error-wc-version-style' );

		wp_register_script( 'admin-error-wc-version-script', COGITO_BOT__PLUGIN_URL .'assets/js/admin-error-wc-version-script.js' );
